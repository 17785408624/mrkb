...
import com.mrkb.common.utils.weixinutils.CrateJson;
import com.mrkb.common.utils.weixinutils.MyX509TrustManager;
import com.mrkb.dao.modle.weixin.often.Token;



/**
* 类名: WeixinMenuService 
* 描述: 公众平台通用接口工具类 
* 开发人员： 万祖权  
* 创建时间：  2017-12-27 
 */
public class WeixinMenuService {
    ...
    private static Logger log = LoggerFactory.getLogger(WeixinMenuService.class);
...
//    }
    public static int createMenu(String accessToken) {
        ...
        String url = menu_create_url.replace("ACCESS_TOKEN", accessToken);
        // 将菜单对象转换成json字符串
     String jsonMenu=new CrateJson().getMenu().toString();
   //发送创建菜单请求
     JSONObject jsonObject = httpRequest(url, "POST", jsonMenu);
